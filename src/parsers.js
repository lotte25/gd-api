...
function parseLevel(str) {
    ...
    let levelData = {
        ...
        completions: Number(splitted.get("11")),
...
function parseUser(str) {
    ...
    return {
        ...
        accountHighlight: Number(splitted.get("7")),
        ...
        accStreak: Number(splitted.get("27")),
        ...
        messages: Number(splitted.get("38")),
        friendRequests: Number(splitted.get("39")),
        newFriends: Number(splitted.get("40")),
